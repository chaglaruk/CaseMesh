...
2. Preserve 24 kHz mono PCM framing and follow the current dedicated Realtime Transcription guide, which presently recommends `gpt-live-transcribe`; use only context/language/noise/VAD fields supported by the current API.
