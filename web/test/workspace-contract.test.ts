...
describe("Matter workspace contract",()=>{
  ...
  it("supports bounded Matter Q&A and explicit thread reset",()=>{expect(page).toContain("/questions/ask");expect(page).toContain("maxLength={1000}");expect(page).toContain("New thread");expect(page).toContain("What your evidence shows");});
